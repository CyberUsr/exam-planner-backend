...
export class MateriiController {
  ...
  @ApiResponse({ status: 200, description: 'Professors have been added to the subject.' })
  @ApiResponse({ status: 404, description: 'Subject not found.' })
  ...
  @ApiResponse({ status: 200, description: 'Assistants have been added to the subject.' })
  @ApiResponse({ status: 404, description: 'Subject not found.' })
  ...
  @ApiResponse({ status: 200, description: 'Returns subjects grouped by specialization.' })
